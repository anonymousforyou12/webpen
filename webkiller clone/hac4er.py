...
while True:
    ...
    try:
        helpp.Banner()
        helpp.infolist1()
        number = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"Hac4er"+Fore.BLUE+"~"+Fore.YELLOW+"@HOME"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ").lower()
    except:
        print("\n God Lock :) ")
        sys.exit()
...
#Information Gathering
        ...
        try:
            helpp.Banner()
            helpp.infolist2()
            infor = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"Hac4er"+Fore.BLUE+"~"+Fore.YELLOW+"@HOME"+Fore.RED+"/"+Fore.CYAN+"Information Gathering"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ").lower()
...
#------------------------------------------------------------------------------------------------
        ...
        helpp.infolist4()
        try:
            numcms = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"Hac4er"+Fore.BLUE+"~"+Fore.YELLOW+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMS Detection"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ").lower()
        ...
        if numcms == "1":
            helpp.infowp()
            try:
                wp = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"Hac4er"+Fore.BLUE+"~"+Fore.YELLOW+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WordPress"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ").lower()
            except:
                print("")
                sys.exit()
