...
def __start__():
 ...
 [!] Please Enter The Target Website Address\n""")
    ...
    site = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"Hac4er"+Fore.BLUE+"~"+Fore.YELLOW+"@HOME"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Bypass-CloudFlare"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ")
    if site == "":
        try:
